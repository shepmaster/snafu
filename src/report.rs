...
fn request_location(e: &dyn crate::Error) -> Option<&crate::Location<'static>> {
    #[cfg(feature = "unstable-provider-api")]
    {
        use crate::error;

        error::request_ref::<&'static crate::Location>(e)
            .copied()
            .or_else(|| error::request_ref::<crate::Location>(e))
            .or_else(|| error::request_value::<&'static crate::Location>(e))
    }
